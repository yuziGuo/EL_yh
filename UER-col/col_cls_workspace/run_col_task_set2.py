...
if __name__ == '__main__':
    ...
    op_2_2 = {'pooling': 'avg-cell-seg', 'mask_mode': 'row-wise'}  # 目前效果都很差
    ...
    for ds_options in [op_3_2]:
        for key_options in [op_2_1, op_2_2, op_2_3, op_2_4]:
            predefined_dict_groups = {
                                      'debug_options':{
                                          'logger_dir_name': 'col_cls_workspace/log_debug_recover_dup',
                                          'logger_file_name': 'col_cls_workspace/rec_all_debug_recover_dup'
                                      },
