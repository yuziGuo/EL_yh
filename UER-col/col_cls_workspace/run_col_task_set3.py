...
if __name__ == '__main__':
    ...
    op_2_3 = {'pooling': 'avg-token', 'mask_mode': 'cross-and-hier-wise'}
    op_2_4 = {'pooling': 'avg-token', 'mask_mode': 'col-wise'}
    ...
    for ds_options in [op_3_2]:
        for key_options in [op_2_1, op_2_3, op_2_4]:
            predefined_dict_groups = {
                'key_set_group': key_options,
                'ds_set_group': ds_options,
                'debug_options':{
                  'logger_dir_name': 'col_cls_workspace/log_debug_recover_avg_tokens',
                  'logger_file_name': 'col_cls_workspace/rec_all_debug_recover_avg_tokens'
                },
            }
